...
{
    public partial class psumenu : Form
    {
        private MainApp mainApp;
        public psumenu(MainApp mainApp)
        {
            InitializeComponent();
        ...
        private void psumenu_Load(object sender, EventArgs e)
        {
        ...
        {
            psumenu psuMenuForm = this;
            DisplayManager displayManager = new DisplayManager(psuMenuForm);
        }
