...
{
    public partial class gpumenu : Form
    {
        private MainApp mainApp;
        public gpumenu(MainApp mainApp)
        {
            InitializeComponent();
        ...
        private void gpumenu_Load(object sender, EventArgs e)
        {
            InitializeDisplayManager();
        }
        private void InitializeDisplayManager()
        {
            gpumenu gpuMenuForm = this; // Pass the current instance of cpumenu
            DisplayManager displayManager = new DisplayManager(gpuMenuForm);
        }
