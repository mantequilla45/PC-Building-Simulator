...
{
    public partial class mbmenu : Form
    {
        private DatabaseManager dbManager;
        private MainApp mainApp;
        public mbmenu(MainApp mainApp)
        {
            InitializeComponent();
        ...
        private void mbmenu_Load(object sender, EventArgs e)
        {
        ...
        {
            mbmenu mbMenuForm = this;
            DisplayManager displayManager = new DisplayManager(mbMenuForm);
        }
