...
{
    public partial class monitormenu : Form
    {
        private MainApp mainApp;
        public monitormenu(MainApp mainApp)
        {
            InitializeComponent(); 
        ...
        private void monitormenu_Load(object sender, EventArgs e)
        {
        ...
        {
            monitormenu monitorMenuForm = this;
            //DisplayManager displayManager = new DisplayManager(monitorMenuForm);
        }
